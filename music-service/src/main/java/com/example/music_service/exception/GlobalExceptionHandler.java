package com.example.music_service.exception;

import com.example.music_service.dto.response.ApiResponse;
import com.example.music_service.error.BaseErrorCode;
import com.example.music_service.error.InvalidErrorCode;
import com.example.music_service.exception.AppException;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse<Void>> methodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        } catch (IllegalArgumentException | ValidationException | IllegalStateException ignored) {}
