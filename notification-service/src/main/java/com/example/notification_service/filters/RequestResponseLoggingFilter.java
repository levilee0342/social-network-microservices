...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            loggingUtil.logInfo("user-service", "[API NOTIFICATION-SERVICE] Request/Response: " + toJson(logMap), logMap);
            ...
            loggingUtil.logError("user-service", "[API NOTIFICATION-SERVICE] ERROR during request", errorLogMap, ex);
