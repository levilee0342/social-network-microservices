...
import com.example.user_service.entity.Log;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, EmailMessageRequest> emailKafkaTemplate() {
    ...
    @Bean
    public KafkaTemplate<String, FriendNotificationRequest> notificationKafkaTemplate() {
        return createKafkaTemplate(createProducerFactory());
    }

    @Bean
    public KafkaTemplate<String, EventPresence> eventPresenceKafkaTemplate() {
        return createKafkaTemplate(createProducerFactory());
    }
