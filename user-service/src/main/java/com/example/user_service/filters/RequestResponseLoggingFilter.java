...
import com.example.user_service.utils.LoggingUtil;
...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            loggingUtil.logInfo("user-service", "[API USER-SERVICE] Request/Response: " + toJson(logMap), logMap);
            ...
            loggingUtil.logError("user-service", "[API USER-SERVICE] ERROR during request", errorLogMap, ex);
