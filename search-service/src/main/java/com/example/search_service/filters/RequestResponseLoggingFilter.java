package com.example.search_service.filters;

import com.example.search_service.utils.LoggingUtil;
...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            loggingUtil.logInfo("user-service", "[API SEARCH-SERVICE] Request/Response: " + toJson(logMap), logMap);
            ...
            loggingUtil.logError("user-service", "[API SEARCH-SERVICE] ERROR during request", errorLogMap, ex);
