package com.example.trending_service.filters;

import com.example.trending_service.utils.LoggingUtil;
...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            loggingUtil.logInfo("trending-service", "[API TRENDING-SERVICE] Request/Response: " + toJson(logMap), logMap);
            ...
            loggingUtil.logError("trending-service", "[API TRENDING-SERVICE] ERROR during request", errorLogMap, ex);
